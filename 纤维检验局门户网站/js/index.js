...
$(".xjyx_btn").on("click", function () {
    ...
    $(this).append($(html));
    //切换右边对应数据
    var list = '<div class="news_content_list">' +
        ' <div class="news_content_list_r">' +
        ' <div class="news_content_list_r_tit">工会第二小组开展“徒步康道舒身心 健康生活走起来”主题登山活动' +
        ' </div>' +
        ' <div class="news_content_list_r_msg"> 近日，为丰富会员的业余文化生活，倡导绿色、健康的生活方式，在局工会的关心指导下，工会第二小组开展了“徒步康道舒身心健康生活走起来”主题登山活动。' +
        '</div>' +
